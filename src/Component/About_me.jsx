  ...
  return (
    <>
      <div className="flex items-center justify-around px-[10%] gap-6 mt-6 mb-6">
        <div>
          {" "}
          <img src={img} alt="photo" className=" rounded-lg" />
        </div>
        <div>
          <div className="">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eligendi
            beatae asperiores ea corporis modi dolore porro quasi quas, eos,
            officia sit laudantium provident quisquam veniam explicabo unde est
            quidem voluptas.
          </div>
          <div>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam
            suscipit eius dicta? Minus laborum tenetur maxime quas facere, cum
            autem.
          </div>
      ...
      <div className="px-[20px] py-[40px] flex items-center justify-around text-4xl ">
        <div>
          <div className="inline-block ">10+</div> <br />
        ...
        <div class="vl"></div>
        <div>
          <div className="inline-block ">2 </div> <br />
          <div className="text-xl items-center justify-center ">
            happy clients
          </div>
        </div>
        ...
        <div>
          <div className="inline-block">2</div> <br />
          <div className="text-xl items-center justify-center ">projects</div>
        </div>
      </div>
    </>
  );
